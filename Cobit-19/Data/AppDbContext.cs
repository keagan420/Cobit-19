    ...
    public class AppDbContext : IdentityDbContext<ApplicationUser>  
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AnswerModel>().HasData(
                ...
                new AnswerModel { AuditID = 1, QuestionID = 3, Answer = 2 },
                new AnswerModel { AuditID = 1, QuestionID = 4, Answer = 3 },
                new AnswerModel { AuditID = 1, QuestionID = 5, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 6, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 7, Answer = 2 },
                new AnswerModel { AuditID = 1, QuestionID = 8, Answer = 3 },
                new AnswerModel { AuditID = 1, QuestionID = 9, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 10, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 11, Answer = 2 },
                new AnswerModel { AuditID = 1, QuestionID = 12, Answer = 3 },
                new AnswerModel { AuditID = 1, QuestionID = 13, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 14, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 15, Answer = 2 },
                new AnswerModel { AuditID = 1, QuestionID = 16, Answer = 3 },
                new AnswerModel { AuditID = 1, QuestionID = 17, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 18, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 19, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 20, Answer = 1 }, 
                new AnswerModel { AuditID = 1, QuestionID = 21, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 22, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 23, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 24, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 25, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 26, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 27, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 28, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 29, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 30, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 31, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 32, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 33, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 34, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 35, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 36, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 37, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 38, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 39, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 40, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 41, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 42, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 43, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 44, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 45, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 46, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 47, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 48, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 49, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 50, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 51, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 52, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 53, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 54, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 55, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 56, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 57, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 58, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 59, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 60, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 61, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 62, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 63, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 64, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 65, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 66, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 67, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 68, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 69, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 70, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 71, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 72, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 73, Answer = 1 },
                new AnswerModel { AuditID = 1, QuestionID = 74, Answer = 1 }
                );
